package kr.ac.hansung.cse.hellospringhateos.controller;

import kr.ac.hansung.cse.hellospringhateos.assembler.ActorModelAssembler;
import kr.ac.hansung.cse.hellospringhateos.assembler.AlbumModelAssembler;
...
import kr.ac.hansung.cse.hellospringhateos.model.ActorModel;
import kr.ac.hansung.cse.hellospringhateos.model.AlbumModel;
import kr.ac.hansung.cse.hellospringhateos.repository.ActorRepository;
import kr.ac.hansung.cse.hellospringhateos.repository.AlbumRepository;
...
public class WebController {
    ...
    public ResponseEntity<CollectionModel<ActorModel>> getAllActors()
    {
        ...
        //return ResponseEntitly.ok(albumModelAssembler.toCollectionModel(actorEntities));
    }
